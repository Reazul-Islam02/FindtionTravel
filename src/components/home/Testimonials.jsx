...
const testimonials = [
    {
        ...
        content: "FindtionTravel helped me plan the most incredible trip to Bali. The local tips were invaluable!",
        rating: 5,
            ...
            <div className="container-max">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <p className="text-slate-600 text-lg">
                        Hear from our community about their experiences exploring the world with FindtionTravel.
                    </p>
                </div>
