            ...
            <div className="container-max">
                ...
                <div className="max-w-4xl mx-auto text-center mb-24">
                    ...
                    <p className="text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto text-pretty">
                        FindtionTravel was founded by a group of travel enthusiasts who believed that life is too short for boring vacations. We curate the extraordinary so you can experience the unforgettable.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-lg text-slate-600 leading-relaxed text-pretty">
                            At FindtionTravel, we are on a mission to bring people closer to the wonders of our planet. We believe that travel fosters empathy, breaks down barriers, and enriches the soul.
                        </p>
                        <p className="text-lg text-slate-600 leading-relaxed text-pretty">
